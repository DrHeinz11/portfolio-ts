...
const ReleaseProjects: FC = (props: Props) => {
  return (
    <div className='grid-cols-projectContainer grid gap-8 py-10 px-4 items-center bg-[#0b0b0b]'>
      ...
      {RelaseProjectData.map(element => <ReleaseCard title='as' key={element.id} id={element.id} paragraph={element.paragraph} imgUrl='https://pbs.twimg.com/media/Fg60v3XXgAAfUIg?format=jpg&name=4096x4096' imgAlt='prueba' route='/dsdas' links={{ repository: 'dasdas', deploy: 'dasdas' }} />)}
      <ReleaseCta />
    </div>
  )
}
