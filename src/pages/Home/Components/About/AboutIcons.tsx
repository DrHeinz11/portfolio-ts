...
import { Css3, Figma, Git, Github, Html5, JavaScript, React, Sass, Tailwind, Terminal, TypeScript, VisualStudio } from '../../../../components'
...
const dataToll = [{ text: 'Git', icon: <Git />, id: 122 },{ text: 'Figma', icon: <Figma />, id: 126 }, { text: 'VSCode', icon: <VisualStudio />, id: 123 }, { text: 'Github', icon: <Github />, id: 124 }, { text: 'Terminal', icon: <Terminal />, id: 125 }]
